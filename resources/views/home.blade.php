...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            ...
            <h1 class="mb-1 font-medium">Eloquent</h1>
            <div class="flex flex-col gap-3">
                <div>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Many To Many Relationship</p>
                    <ul class="flex flex-col gap-3 text-sm leading-normal">
                        <li>
                            <a href="{{ route('eloquent.many-to-many-relationship.index') }}" target="_blank"
                ...
                <div>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Polymorphic Relationship</p>
                    <ul class="flex flex-col gap-3 text-sm leading-normal">
                        <li>
                            <a href="{{ route('eloquent.polymorphic-relationship.one-to-one') }}" target="_blank"
                               class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal">
                                One to One
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('eloquent.polymorphic-relationship.one-to-many') }}" target="_blank"
                               class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal">
                                One to Many
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('eloquent.polymorphic-relationship.many-to-many') }}" target="_blank"
                               class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal">
                                Many to Many
                            </a>
                        </li>
